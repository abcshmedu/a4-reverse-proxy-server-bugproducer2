 ...
 */
public class RestTestJsonExceptions {
    ...
    @Test
    public void testCreateBookWrongAuthor() throws IOException {
        JSONObject book = new JSONObject();
        book.put("title", TITLE);
        book.put("authorW", NAME);
        book.put("isbn", ISBN);
    ...
    @Test
    public void testCreateBookWrongTitle() throws IOException {
        JSONObject book = new JSONObject();
        book.put("titel", TITLE);
